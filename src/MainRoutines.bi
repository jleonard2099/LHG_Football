...
Declare Sub Hd2HdCon_Report (teamName$, conf1$, conf2$, divisionNames$(), divisionNames_2nd$(), secondConf, printDest)
Declare Sub Hd2HdCon_Screen (teamName$, conf1$, conf2$, divisionNames$(), divisionNames_2nd$(), secondConf)
Declare Sub Hd2HdPro_League (secondLeague)
Declare Sub Hd2HdPro_Report (teamName$, leag1$, leag2$, divisionNames$(), divisionNames_2nd$(), secondLeague, printDest)
Declare Sub Hd2HdPro_Screen (teamName$, leag1$, leag2$, divisionNames$(), divisionNames_2nd$(), secondLeague)
