...
Declare Sub CalcStatLeaders (numberGames, leagLdrTeams$, WT$, finalUpdate$)
Declare Sub CalcStatTotalsConf (numberGames, leagLdrTeams$, WT$, finalUpdate$)
Declare Sub CalcStatTotalsPro (numberGames, leagLdrTeams$, WT$, finalUpdate$)
Declare Sub CAREDIT ()
Declare Sub CAREER ()
...
Declare Sub EditGame (DT$, leagLdrTeams$)
...
Declare Sub NewGame (visitor$, visitorQB$, home$, homeQB$, YN$, DT$, leagLdrTeams$, NTMS, gameIndex%)
...
Declare Sub ReadStatsLeaders (statFile$, numberGames, leagLdrTeams$, proQB)
