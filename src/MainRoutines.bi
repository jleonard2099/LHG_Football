...
Declare Sub HD2HDCOLL ()
Declare Sub HD2HDLEAG ()
Declare Sub Hd2HdColl_Conf (X2)
Declare Sub Hd2HdColl_Report (teamName$, conf1$, conf2$, DV$(), DV2$())
Declare Sub Hd2HdColl_Screen (teamName$, conf1$, conf2$, DV$(), DV2$())
...
Declare Sub PostLeadersOrg (leaderFile$)
...
Declare Sub SaveTradeStats (saveIdx)
