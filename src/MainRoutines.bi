...
Declare Sub Hd2HdColl_Report (A$, conf1$, conf2$, DV$(), DV2$())
Declare Sub Hd2HdColl_Screen (A$, conf1$, conf2$, DV$(), DV2$())
Declare Sub Hd2HdPro_League (X2)
Declare Sub Hd2HdPro_Report (A$, leag1$, leag2$, DV$(), DV2$())
Declare Sub Hd2HdPro_Screen (A$, leag1$, leag2$, DV$(), DV2$())
